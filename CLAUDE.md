...
apps/                       서비스 코드 모음
apps/order-service/         주문 서비스 (FastAPI + PostgreSQL + Redis)
apps/inventory-service/     재고 서비스 (FastAPI + PostgreSQL)
apps/notification-service/  알림 서비스 (FastAPI + Celery + Redis + Kafka)
```
...
→ [apps/CLAUDE.md](apps/CLAUDE.md) 참고
